(function ($, Drupal) {
  ...
  Drupal.behaviors.componentFeaturedContentLayoutMasonry = {
    attach: function (context, settings) {
      $('.component-featured-content--layout-masonry:not(.component-featured-content--js-initialized)').each(function (index) {
        var $component = $(this);
        ...
        $component.find('.component-featured-content__list-item').each(function (index) {
          ...
          // Add size class.
          $(this).addClass('component-featured-content__list-item--size-' + size);
        });
        ...
        $component.addClass('component-featured-content--js-initialized');
      });
    }
  };
